...
```text
adr-v0.1.0-win32-x64.zip
adr-v0.1.0-linux-x64.tar.gz
adr-v0.1.0-darwin-arm64.tar.gz
```
...
```bash
code --install-extension agent-diff-review-vscode-0.1.0@win32-x64.vsix
```
...
```text
agent-diff-review-codex-v0.1.0-win32-x64.zip
```
